  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 w-full h-full max-w-7xl 2xl:max-w-[1440px] mx-auto px-4 sm:px-10 lg:px-16 flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-6 sm:gap-10 lg:gap-8 pt-28 sm:pt-32 lg:pt-0 pb-28 sm:pb-32 lg:pb-[6vh] pointer-events-none">
        ...
        <div className="w-full lg:w-1/2 pointer-events-auto lg:pl-6 xl:pl-8 2xl:pl-10">
          <motion.div style={{ y: textY, opacity: textOpacity }} className="text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {/* Pre-título superior */}
                <p className={`font-montserrat not-italic text-xs sm:text-sm md:text-base font-semibold tracking-wider uppercase mb-2 ${
                ...
                <p className="font-montserrat not-italic max-w-[300px] sm:max-w-md md:max-w-lg text-slate-600 text-sm sm:text-base md:text-lg font-normal tracking-[0.035em] mb-5 sm:mb-8 leading-relaxed">
                  {mode === 'agua' 
                    ? "Maquinas vending de agua, purificadoras comerciales y soluciones de tratamiento de agua para un futuro mas saludable y rentable."
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              onClick={handleCTA}
              className={`relative z-30 inline-flex items-center justify-center text-white font-bold py-3 sm:py-3.5 px-8 sm:px-12 rounded-full transition-all duration-300 text-xs sm:text-sm uppercase tracking-widest group overflow-hidden font-montserrat not-italic ${
                mode === 'agua'
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-end translate-y-5 sm:translate-y-8 lg:translate-y-12 xl:translate-y-14 pointer-events-auto">
                ...
                >
                  ...
                  <div className="relative flex items-center justify-center">
                    <motion.img 
                      ...
                      className="w-[245px] sm:w-[350px] md:w-[420px] lg:w-[490px] xl:w-[560px] 2xl:w-[620px] h-auto max-h-[52vh] sm:max-h-[60vh] lg:max-h-[68vh] xl:max-h-[72vh] object-contain drop-shadow-[0_25px_45px_rgba(0,0,0,0.28)] z-10" 
                    />
                  </div>
                </motion.div>
              ) : (
      ...
      >
        <div className="w-full max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-4xl bg-white/90 sm:bg-white/95 backdrop-blur-md shadow-lg sm:shadow-2xl rounded-2xl border border-white/80 overflow-hidden grid grid-cols-3 divide-x divide-slate-200/80">
          ...
          >
            ...
            <p className="font-black text-slate-900 text-[9px] sm:text-xs uppercase tracking-wider text-center font-montserrat not-italic">Beneficios 24/7</p>
          </motion.button>
          <motion.button 
            type="button"
            whileHover={{ y: -2 }}
          ...
          >
            ...
            <p className="font-black text-slate-900 text-[9px] sm:text-xs uppercase tracking-wider text-center font-montserrat not-italic">Agenda Llamada</p>
          </motion.button>
          <motion.a 
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.98 }}
          ...
          >
            ...
            <p className="font-black text-slate-900 text-[9px] sm:text-xs uppercase tracking-wider text-center font-montserrat not-italic">WhatsApp</p>
          </motion.a>
        </div>
      </motion.div>
