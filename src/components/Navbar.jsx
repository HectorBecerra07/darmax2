      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-black shadow-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between h-20 px-4 md:px-6 lg:px-8">
          ...
          <div className="hidden md:flex items-center justify-center gap-6 lg:gap-8 flex-1">
            <Link to="/inicia-tu-negocio" className={`${textColor} font-semibold hover:text-[#ccff00]`}>
              INICIA TU NEGOCIO
            </Link>
            <Link to="/productos" className={`${textColor} font-semibold hover:text-[#ccff00]`}>
              PRODUCTOS
            </Link>
            <Link to="/PurificadoresCaseros" className={`${textColor} font-semibold hover:text-[#ccff00]`}>
              PURIFICADORES CASEROS
            </Link>
            <Link to="/promociones" className={`${textColor} font-semibold hover:text-[#ccff00]`}>
              PROMOCIONES
            </Link>
            <Link to="/proyectos-empresariales" className={`${textColor} font-semibold hover:text-[#ccff00]`}>
              PROYECTOS
            </Link>
            <Link to="/nosotros" className={`${textColor} font-semibold hover:text-[#ccff00]`}>
              NOSOTROS
            </Link>
          </div>
        ...
        >
          ...
          <ul className="flex flex-col items-center font-medium space-y-6 pb-6">
            ...
            <li><Link to="/PurificadoresCaseros" className="text-black text-lg" onClick={() => setNavOpen(false)}>PURIFICADORES CASEROS</Link></li>
